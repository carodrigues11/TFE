...
class ProfilvendeuroccController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            // À partir de maintenant, la variable $boutique contient les valeurs entrées dans le formulaire par le visiteur
        ...
        return $this->render('CRShopBundle:Default:creationprofilvendeurocc.html.twig', array(
